...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Coinbase** | US · 핀테크(암호자산 거래소) | **도메인 2개뿐**(내부 운영을 통제된 플랫폼으로 모은다[tech 5] / AI 에이전트를 기업 규모로 쓴다[tech 0 · ⏳ 미독]) · **기능 1**(distribute-capability-centralize-control) · **하나 남았다 — CEEcil(2026-08-28) · 기업용 AI 에이전트(2025-12-22), 주소 확보** · ⚠️ **거래소 본체와 보안 자료가 없다** · ✅ `r.jina.ai` |
