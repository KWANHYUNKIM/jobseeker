...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Sansan** | JP · SaaS | 330 에서 첫 기능 `rebind-what-was-attached`(그릇을 옮기고 붙어 있던 것을 다시 맨다)를 썼다 — **도메인 1개 · 기능 1개 · 결정 7개.** **⭐ 사업의 심장(명함·청구서 인식, Bill One +41.3%)은 아직 안 팠다** — 분류가 R&D 347편 · ML 64편이라 다음은 거기. **⭐⭐ 실물 원본 관리 축도 후보로 남아 있다**(대담 형식이라 버린 대안 0) |
