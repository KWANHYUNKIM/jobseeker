...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Cybozu (サイボウズ)** | JP · SaaS | **306 회사 프로파일 완료. 도메인 1개 · 기능 0개.** ① `이십 년 된 것을 멈추지 않고 옮긴다`(**본문 확인** — StatefulSet 을 버린 이유, 같은 노드 제약, 수억 파일, 커널까지 조사). **실적 확보** — 2025년 매출 **374억 3천만 엔(+26.1%)** · 영업이익 **101억 엔(+106.4%)** · kintone **216억 엔(+33.9%)**. **⚠️ 도메인 ① 두 번째 편 주소 확보**(`/entry/2026/08/06/113000` · `/entry/2026/07/27/113000`) |
