...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **DoorDash** | US · 커머스(배달·물류) | 프로파일 완료 · **eras 3시기** · 도메인 3(모놀리스를 쪼개되 코드가 아니라 기능을 옮긴다[tech 5] / 에이전트에게 노트북 대신 통제된 환경을 준다[tech 4] / **주문과 배차를 실시간으로 흘린다[tech 0 — 자료 미확보]**) · **기능 1**(extract-function-not-code) |
