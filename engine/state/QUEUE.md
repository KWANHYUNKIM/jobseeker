...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Bolt** | EU(에스토니아) · 모빌리티 | 프로파일 완료 · 도메인 3(과잉설계했다고 적고 되돌아온다[tech 2] / 돈이 어디까지 왔는지 끝까지 센다[tech 3] / 엔진을 하나로 모은다[tech 3]) · **기능 2**(checkpoint-back-to-simple / psp-reconciliation) |
