...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Cursor** | US · SaaS(AI 코딩 에이전트) | 프로파일 완료 · 도메인 3(깃을 어떤 규모에서든 다룬다[tech 0 · ✅ 본문 확인] / 에이전트를 클라우드에서 돌린다[tech 0 · ⏳ 미독] / 모델을 고르고 돌린다[tech 0 · ⏳ 미독]) · **기능 0** · ⭐ **ARR 1억 → 40억 달러, 3개월마다 두 배** · ⚠️ **일부 글 주소는 검색으로 받아야 한다** · ✅ `r.jina.ai` |
