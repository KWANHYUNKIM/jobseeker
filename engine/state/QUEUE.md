...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Vercel** | US · SaaS(프런트엔드/AI 클라우드) | 도메인 3(자기 인프라를 옮긴다[tech 3] / 에이전트를 안전하게 실행한다[tech 0 · ⏳ 글 넷 미독] / 컴퓨트를 어떤 모양으로든[tech 0 · ⏳ 미독]) · **기능 1**(cache-holding-what-cannot-be-lost) · ⭐ **2026년 글 열 편 중 넷이 에이전트 실행·자격증명** · ✅ `r.jina.ai` |
