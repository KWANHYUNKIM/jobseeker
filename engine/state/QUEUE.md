...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Wise** | EU(UK) · 핀테크(국경 간 송금) | 프로파일 완료 · 도메인 3(서비스 천 개를 도구로 한 벌로 만든다[tech 4] / 배포를 거래가 아니라 사건의 흐름으로 본다[tech 3] / 관측 스택을 옮기고 나서야 진짜 비용을 만난다[tech 4]) · **기능 1**(standards-as-dependencies) |
