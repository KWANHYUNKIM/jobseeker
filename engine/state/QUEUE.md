...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Pinterest** | US · 소셜(발견·추천) | 프로파일 완료 · 도메인 3(홈피드에 무엇을 꺼내 올지 조건에 따라 정한다[tech 0 · ✅ 본문 확인] / 사용자를 어떤 쓰임새로 이해할지 정한다[tech 0 · ⏳ 미독] / 인프라 자원을 안전하게 내준다[tech 0 · ⏳ 미독]) · **기능 0** · ✅ **`r.jina.ai` 로 목록·본문이 온다** |
