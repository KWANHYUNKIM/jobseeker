...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Atlassian** | AU · SaaS(협업 도구) | 프로파일 완료 · 도메인 3(검색 색인을 살아 있는 채로 바꾼다[tech 0 · ✅ 본문 확인] / 이벤트를 옮기고 전달한다[tech 0 · ⏳ 미독] / AI 를 제품에 넣는다[tech 0 · ⏳ 미독]) · **기능 0** · ⚠️ **`how-we-build` 아카이브가 제목만 주고 날짜도 없다 — 주소는 매번 검색으로** · ✅ `r.jina.ai` |
