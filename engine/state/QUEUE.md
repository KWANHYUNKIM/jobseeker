...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Vercel** | US · SaaS(프런트엔드/AI 클라우드) | 도메인 3(자기 인프라를 옮긴다[tech 3] / 에이전트를 안전하게 실행한다[tech 5] / 컴퓨트를 어떤 모양으로든[tech 0 · ⏳ 미독]) · **기능 2** · **하나 남았다 — Fluid compute(2026-09-01), 주소 확보** · ⏳ **보강: Run SDK · v0 의 OAuth · Agent Plugins** · ✅ `r.jina.ai` |
