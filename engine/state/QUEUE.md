...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Sansan** | JP · SaaS | 329 에서 프로파일을 썼다 — **도메인 1개 · 기능 0개.** 도메인은 `저장소를 옮기면 붙어 있던 것이 따라오지 않는다` 이고 **본문 두 편**(모노레포 이관 2024-05-27 · GitHub Enterprise 이관 2025-12-19)으로 받쳤다. **⭐ 사업의 심장(명함·청구서 인식)은 아직 안 팠다** — 분류가 R&D 347편 · ML 64편이라 다음에 거기를 본다 |
