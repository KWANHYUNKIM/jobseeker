...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Anthropic** | US · SaaS | ⭐ **기능 1/3**(2026-09-06). ✅ `자 자체를 의심한다`(점수를 믿기 전에 무엇을 확인하나 — 결정 7개, 그림 2장, 하드 프라블럼 2개). ⏳ 남은 둘 — `뇌와 손을 떼어 놓는다`(Managed Agents) · `틀린 것을 공개한다`(4월 23일 포스트모템). ⭐ **1차 자료가 직접 열린다.** ⚠️ **학습 인프라 자료는 아직 못 찾았다.** |
