...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Atlassian** | AU · SaaS(협업 도구) | 도메인 3(검색 색인을 살아 있는 채로 바꾼다[tech 5] / 이벤트를 옮기고 전달한다[tech 5] / AI 를 제품에 넣는다[tech 0 · ⏳ 미독]) · **기능 2** · **하나 남았다 — Rovo 에이전트 하네스** · ⚠️ **`how-we-build` 아카이브가 제목만 준다 — 주소는 검색으로**(네 번 연속 통했다) · ✅ `r.jina.ai` |
