...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **freee** | JP · SaaS | 338 에서 프로파일을 썼다 — **도메인 1개 · 기능 0개.** 도메인은 `모든 제품이 기대던 것을 떼어낸다` 이고 다음 기능은 **인증·인가 기반 마이크로서비스화 4년의 회고**(2022-08-31, 후회를 명시하는 드문 글). **블로그가 크고 살아 있다**(최신 2026-08-20 · 기술 291편) |
