...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Twilio** | US · SaaS(통신 API) | 프로파일 완료 · 도메인 2(알림을 보내는 시스템을 책임별로 쪼갠다[tech 0 · ✅ 본문 확인] / 쪼개진 콘솔을 다시 하나로 합친다[tech 0 · ✅ 본문 확인, ⚠️ 2021년 글]) · **기능 0** · ✅ WebFetch 로 본문이 온다. ⚠️ **대부분이 고객용 가이드 — 자기 시스템 글은 검색으로 골라야 한다** |
