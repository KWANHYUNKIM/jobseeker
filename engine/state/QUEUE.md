...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Wiz** | US(뉴욕, 이스라엘 창업) · SaaS(클라우드 보안) | 도메인 3(민감 데이터를 찾는다[tech 5] / 에이전트 없이 클라우드를 들여다본다[tech 0 · ⏳ 미독] / 코드를 훑는다[tech 0 · ⏳ 미독]) · **기능 1**(build-free-then-strip-ai) · ⭐ **①축에 유일한 `넣었다가 다시 뺐다`** · ⚠️ **블로그 대부분이 제품 발표와 위협 연구** · ✅ `r.jina.ai` |
