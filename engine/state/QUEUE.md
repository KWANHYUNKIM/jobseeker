...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Etsy** | US · 커머스(수공예 마켓플레이스) | 프로파일 완료 · 도메인 3(16년 된 샤딩을 데이터를 안 옮기고 갈아 끼운다[tech 5] / 바꾸는 것마다 실험으로 켠다[tech 2] / 1억 개가 서로 다른 물건에서 원하는 것을 찾게 한다[tech 1]) · **기능 1**(coupled-anyway-despite-going-slow) |
