...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Neon** | US · SaaS(서버리스 Postgres) | 프로파일 완료 · **도메인 2개뿐**(저장을 계산과 떼어 놓는다[tech 0 · ✅ 본문 확인] / 쓰지 않을 때 0 으로 내린다[tech 0 · ⏳ 미독]) · **기능 0** · ⭐ **프로비저닝의 80% 이상을 AI 에이전트가 한다** · ⚠️ **시스템 내부 글이 둘뿐이다** · ✅ `r.jina.ai` |
