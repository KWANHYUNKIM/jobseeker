...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Wiz** | US(뉴욕, 이스라엘 창업) · SaaS(클라우드 보안) | 프로파일 완료 · 도메인 3(민감 데이터를 찾는다[tech 0 · ✅ 본문 확인] / 에이전트 없이 클라우드를 들여다본다[tech 0 · ⏳ 미독] / 코드를 훑는다[tech 0 · ⏳ 미독]) · **기능 0** · ⚠️ **블로그 대부분이 제품 발표와 위협 연구라 자기 시스템 글은 2026년에 셋뿐이다** · ✅ `r.jina.ai` |
