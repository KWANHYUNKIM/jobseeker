...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Paystack** | NG · 핀테크(아프리카 결제) | 프로파일 완료 · 도메인 2(남이 정한 지원 종료 일정에 맞춰 결제 데이터베이스를 올린다[tech 5] / **아프리카에서 사업체가 돈을 받게 한다[tech 0 — 자료 미확보]**) · **기능 1**(success-is-nothing-changed-after) |
