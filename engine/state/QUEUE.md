...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Meituan (美团)** | CN · 커머스 | **299 회사 프로파일 완료. 도메인 1개 · 기능 0개.** ① `검색이 무엇을 위로 올릴지 정한다`(`美团搜索3.0` **본문 확인** — 버린 대안 셋 · *"四个明显短板"* · 결론의 유효 기간까지 밝힘). **실적 확보** — Q2 2026 매출 **1,050억 위안(+14.4%)** · 조정 순이익 **25억 위안**, 3분기 연속 적자를 끊었다. **⚠️ 도메인 후보 넷을 제목으로만 확인해 뒀다**(DB 자율 운영 · 可信实验 백서 8편 · 평가 벤치마크 · LongCat) |
