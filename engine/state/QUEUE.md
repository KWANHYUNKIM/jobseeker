...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Cursor** | US · SaaS(AI 코딩 에이전트) | 도메인 3(깃을 어떤 규모에서든 다룬다[tech 5] / 에이전트를 클라우드에서 돌린다[tech 5] / 모델을 고르고 돌린다[tech 0 · ⏳ 미독]) · **기능 2** · **하나 남았다 — 라우터·MoE 메가커널(주소는 검색으로)** · ⭐ **⑥축의 가장 극명한 사례** · ✅ `r.jina.ai` |
