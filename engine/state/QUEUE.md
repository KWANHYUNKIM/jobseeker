...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Wiz** | US(뉴욕, 이스라엘 창업) · SaaS(클라우드 보안) | 도메인 3(민감 데이터를 찾는다[tech 5] / 에이전트 없이 클라우드를 들여다본다[tech 5] / 코드를 훑는다[tech 0 · ⏳ 미독]) · **기능 2** · **하나 남았다 — `Rethinking Scanning for the AI Era`**(2026-07-30, 주소 확보) · ⭐ **①축의 유일한 `넣었다가 다시 뺐다`** · ✅ `r.jina.ai` |
