...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **CyberAgent** | JP · 광고 | **247 회사 프로파일 완료. 도메인 2개 · 기능 0개.** ① `광고를 시간에 걸쳐 고르게 뿌린다`(페이싱 — **버린 대안 셋에 이유가 각각 있다**, 이 회사 최고 글) · ② `같은 것을 여러 번 읽지 않게 한다`(캐시 — 광고 쪽은 단단하고 ABEMA 본체 쪽은 인턴 글이라 얕다). **다음 사이클에 ①의 글을 두 편 더 읽고 기능을 쓴다** — `archives/64498`(광고 배송 고속화, 2026-07-09) · `archives/61355`(광고 배송 플랫폼 이설, 2025-12-25) |
