...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Neon** | US · SaaS(서버리스 Postgres) | **도메인 2개뿐**(저장을 계산과 떼어 놓는다[tech 5] / 쓰지 않을 때 0 으로 내린다[tech 0 · ⏳ 미독]) · **기능 1**(log-is-the-database) · **하나 남았다 — 오토스케일링(2026-08-31)·scale to zero 패턴(2026-09-01), 주소 확보** · ⭐ **프로비저닝의 80% 이상을 AI 에이전트가 한다** · ✅ `r.jina.ai` |
