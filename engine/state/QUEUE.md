...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Trendyol** | 기타(튀르키예) · 커머스 | **도메인 4개**(광고를 판다[tech 4] / 찾게 한다[tech 5] / 인프라를 셀프서비스로 내준다[tech 5] / 장애를 AI 로 진단한다[tech 0 · ⏳ 미독]) · **기능 3** · **하나 남았다 — Helyx 4편 · SRE AI 에이전트 · AI 온콜** · ⚠️ **개별 글 주소는 검색으로 받는다**(두 번 연속 통했다) · ✅ `r.jina.ai` |
