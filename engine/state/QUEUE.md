...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Anthropic** | US · SaaS | ⭐ **기능 2/3**(2026-09-06). ✅ `자 자체를 의심한다`(점수를 믿기 전에 무엇을 확인하나) · ✅ `뇌와 손을 떼어 놓는다`(무엇을 떼어 놓고 무엇을 붙여 두나 — 결정 8개, 그림 2장). ⏳ **마지막 하나** — `틀린 것을 공개한다`(4월 23일 포스트모템). ⚠️ **완주 판정 때 수익원 셋이 기능과 이어지는지 본다.** |
