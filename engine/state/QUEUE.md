...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Duolingo** | US · 교육 | 프로파일 완료 · 도메인 3(언제 무엇을 다시 보여 줄지 고른다[tech 4] / 에이전트를 한 번 정의해 여러 곳에 태운다[tech 4] / 테스트를 사람이 아니라 파이프라인이 쓴다[tech 3]) · **기능 1**(when-and-what-are-two-models) |
