...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **Mercado Libre** | 기타(AR) · 커머스 | 프로파일 완료 · **연표 3시기**(1999·2010·2015) · 도메인 3(개발자가 인프라를 몰라도 되게 만든다[tech 4] / 셀로 나눠 장애 반경을 줄인다[tech 3] / 이미 있는 것을 고치지 않고 새 구조로 간다[tech 3]) · **기능 2**(three-clicks-to-production / stock-cells) |
