...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **VictoriaMetrics** | 기타 · SaaS(시계열 DB·관측) | **도메인 2개뿐**(메트릭을 저장하고 찾는다[tech 5] / 오픈소스를 사업으로 만든다[tech 0 · ⏳ 미독]) · **기능 1**(cardinality-not-volume) · **하나 남았다 — `Open Source Is Good Marketing`**(⚠️ **개별 주소를 못 받았다. 슬러그를 추측하지 말고 검색으로**) · ✅ `r.jina.ai` |
