...
| 회사 | 국가·분류 | 상태 |
|---|---|---|
| **VictoriaMetrics** | 기타 · SaaS(시계열 DB·관측) | 프로파일 완료 · **도메인 2개뿐**(메트릭을 저장하고 찾는다[tech 0 · ✅ 본문 확인] / 오픈소스를 사업으로 만든다[tech 0 · ⏳ 미독]) · **기능 0** · ⚠️ **후보 조사 때 적어 둔 위험이 현실이 됐다 — 자기 시스템 글이 얇고 Go 런타임 해설이 더 많다** · ✅ `r.jina.ai` |
