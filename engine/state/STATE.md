...
**아무도 안 판다 — 359 는 비교 문서 갱신 사이클이었다.**
**`where-it-piles-up`(미루되 미룬 것이 안 보이게 한다 — 그럼 그것은 어디에 쌓이는가)** 에
**SmartHR 두 사례와 bol 을 더했다.** 셋에서 **여섯 사례**가 됐다.
**완료 60곳 전부 `done` · 큐 0/3 · 비교 문서 33편.**

**⑭ `--gaps` 는 [후보 조사]** 를 가리켰다. **⚠️ WebSearch 예산 소진으로 불가능해**
사다리 8순위로 갔다.

### 무엇을 더했나

기존 구조(표 → 감추는 장치 → 청구서 표 → 미룰 수 없는 것을 알아보는가 → 갚지 않고 이사한 쪽
→ 아직 없는 것)의 결에 맞춰 넣었고, **절을 하나 새로 만들었다**(`아예 안 미루기로 한 쪽`).

- **SmartHR 접속 쪽 — 미룬 사례.** 미룬 것이 **놀고 있는 접속**에 쌓였고
  (*"クエリを処理していない idle コネクション"*), 청구서는 **월 1회이던 장애가 동시다발로
  오르며** 왔다.
- **SmartHR 부하 시험 쪽 — 미리 잰 사례.** 연 1회 정점을 앞당겨 재 **목표의 4분의 1**임을
  정점 전에 알았다.
- **bol — 미루는 안을 값으로 재고 버린 사례.** 중개 앱을 **2031년까지** 유지하는 길을 접었고,
  데이터 쪽에서도 *"there's nothing as permanent as a temporary solution"* 이라 적는다.

### ⭐ 갱신하면서 나온 것

- **⭐⭐ 미룬 이유를 적은 곳은 SmartHR 하나뿐이다** — *"障害の頻度がいつ上がるのか見当が
  つかないまま、対応を先延ばしにしていた"*. **구조상의 위험은 알았고 몰랐던 것은 언제
  심해지는가였다.** 여섯 사례 중 유일하다.
- **⭐⭐ 같은 회사가 두 번 다 데이터베이스에서 막혔는데 한 번은 늦었고 한 번은 이르다.**
  **차이는 기술이 아니라 신호였다**(추정으로 적었다) — 접속 쪽은 **언제 심해질지 몰라**
  기다렸고, 연말정산 쪽은 **날짜가 정해져 있어** 그 전에 잴 수 있었다.
- **⭐ 감추는 장치에 넷째가 붙었다** — SmartHR 은 감추는 장치가 따로 있었던 게 아니라
  **오토스케일 자체가 그 역할을 했다.** 컨테이너가 늘면 처리량이 는다고 읽히는데
  **실제로 는 것은 접속 수였다.**
- **⚠️ 여섯이 되어도 빈칸은 그대로다** — **숫자로 임계를 적은 곳은 여전히 Careem 하나뿐이다**
  (자연 감소를 기다리면 약 3.5개월). bol 은 기한만 적고 비용은 안 적는다.
  **미루는 쪽을 거부하는 데 숫자가 꼭 필요하지는 않았던 셈이다.**
- **⭐ 새 빈칸도 하나 적었다** — **미루지 않은 쪽의 이득은 원리상 못 잰다.** SmartHR 의 부하
  시험은 약 1개월이 들었는데 **그 한 달을 안 썼다면 무엇이 났을지는 아무도 모른다.**

### 🚨 새로 드러난 것 — 비교 문서에도 인용 유산이 있다

357 은 **회사 JSON 만** 고쳤다. **비교 문서 `.md` 는 안 봤다.**
- **이번에 편집한 `where-it-piles-up.md` 의 9건은 고쳤다**(내 추가분이 아니라 337 이전 유산).
- **⚠️ 나머지 15편에 106건이 남아 있다** — which-way-it-leans **22** · machine-says-so **22** ·
  after-you-measure **18** · reversible-first **9** · who-has-to-change **7** · build-or-buy **6** ·
  what-expires-a-design **5** · what-they-did-not-do **5** · count-not-size **3** ·
  move-the-axis **3** · wrong-yardstick **2** · backpressure **1** · payments **1** ·
  spatial-units **1** · what-guards-the-gate **1**.
- **⚠️ 회사 파일처럼 기계적으로 못 고친다.** 비교 문서는 **여러 회사의 인용이 섞여 있고**
  그중 **한국 회사의 한국어 원문 인용은 정당하다**(toss · kakao · naver · kurly · hyperconnect ·
  coupang · daangn · musinsa · baemin). **인용마다 어느 회사 것인지 보고 갈라야 한다.**

---

**다음 사이클 — 셋 중 하나.**
- **⭐ 1순위 — 비교 문서 인용 보수.** 많은 쪽부터 **which-way-it-leans(22) · machine-says-so(22)**.
  **⚠️ 인용마다 어느 회사 것인지 보고 가른다** — 한국 회사 인용은 그대로 둔다.
  **한 사이클에 한두 편씩.**
- **2순위 — `되돌릴 수 없는 것이 어디에 있는가`(`when-you-cannot-undo.md`) 에 bol 을 더한다.**
  ...
  **⚠️ 그 문서에도 9건의 인용 유산이 있으니 갱신하는 김에 함께 고친다.**
- **3순위 — 한국 회사 인용 전수 확인**(hyperconnect 128 · kurly 110). 357 에서 일부러 안 고쳤고
  **표본 열여섯 개는 다 원문이었으나 전수는 안 봤다.**

**⚠️ 후보 조사는 이 세션에서 막혔다** — WebSearch 예산 소진(200회). **주소를 아는 글만
WebFetch 로 열 수 있다.** 큐가 0/3 이지만 채울 방법이 없다.

**분포** — **60곳 전부 `done`**(US 22 · KR 9 · EU 9 · JP 7 · IN 3 · 기타 3 · CN 2 ·
CA·AU·SG·AE·NG 각 1) · **비교 문서 33편** · **운영 사실 64개.**
...
**긴 문서는 Write 툴로**) · **닫을 때 낡은 문장 다시 본다**(348) · **URL 끝 16진수 해시는
Medium**(349) · **`category`·`country` 허용값**(350) · **세 번째 읽어도 새 사실**(351) ·
**'무엇이 없는지' 를 함께 묻는다**(352) · **실행 안 한 평가는 기능으로 못 쓴다**(353) ·
**요약만 보고 판정하면 과대평가**(354) · **버린 대안 없는 글에서도 결정을 세운다**(355) ·
**검사가 0 을 내면 스크립트부터 의심한다**(356) · **기계적 보수는 예외를 먼저 가른다**(357) ·
**비교 문서의 인용은 하나씩 확인하고 쓴다**(358) ·
**⭐ 새로: 어떤 파일을 편집하면 그 파일에 남은 유산도 함께 본다 — 359 에서 갱신하다 337 이전
위반 9건을 발견해 같이 고쳤고, 그 덕에 비교 문서 전체의 유산 106건을 알게 됐다**(359).
