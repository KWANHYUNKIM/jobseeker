...
const SHAPES: Record<string, React.ReactNode> = {
  ...
  // 행정수도 — 기둥과 삼각지붕을 얹은 관공서.
  //
  // 처음에는 정부세종청사의 물결 지붕을 그렸는데, 16px 에서는 그냥 덩어리였다.
  // 그 건물의 유일한 특징이 곡선인데 곡선은 이 크기에서 제일 먼저 죽는다.
  // 세종을 세종이게 하는 것은 건물 모양이 아니라 '행정중심복합도시'라는 사실이므로,
  // 한눈에 관공서로 읽히는 형태로 바꿨다. 기업 규모의 사무동과는 기둥·삼각지붕으로
  // 갈린다 — 그쪽은 창문 격자다.
  세종: (
    <>
      <path d="M12 2.4 22.4 8.4v1.9H1.6V8.4z" />
      <path d="M4.1 11.6h2.7v7.6H4.1zM9 11.6h2.7v7.6H9zM13.9 11.6h2.7v7.6h-2.7zM18.8 11.6h2.7v7.6h-2.7z" />
      <path d="M2.2 20.4h19.6v2.1H2.2z" />
    </>
  ),
  // 설악산 — 날카로운 봉우리
  강원: (
